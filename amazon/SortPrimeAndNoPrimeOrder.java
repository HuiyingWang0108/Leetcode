...
public class SortPrimeAndNoPrimeOrder {
    public static void main(String[] args) {
        /**
         * 
         * Q2. Given a List of Orders , where each Order is a string . For example :
         * [aax 12 23 ] [ ff kindle ebook] are two orders. Each order has an ID which is
         * first part of the order ( ID of order 1 = aax , ID2 = ff ). The remaining
         * part of the order is referred to as MetaData. There are two types of orders,
         * Prime orders ( which contain non numeric Meta Data) and Non-Prime Orders
         * (which contain Only-Numeric Meta Data). Sort the List of Orders as given
         * below :
